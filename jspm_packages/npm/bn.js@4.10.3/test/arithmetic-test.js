...
describe('BN.js/Arithmetic', function() {
  ...
  describe('.div()', function() {
    ...
    it('should not fail on regression after moving to _wordDiv', function() {
      ...
      p = new BN('ffffffff00000001000000000000000000000000ffffffffffffffffffffffff', 16);
      a = new BN('fffffffe00000003fffffffd0000000200000001fffffffe00000002ffffffff' + 'ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff', 16);
